    ...
    <div className="font-helvetica" id="home">
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col-reverse lg:flex-row-reverse justify-center items-center w-full gap-8 lg:mb-36 mb-8">
      ...
      >
        ...
        >
          <div className="grid lg:grid-cols-2 lg:flex lg:flex-col gap-12 w-full md:px-16 ">
            ...
            <div className="flex  flex-col lg:flex-row lg:gap-8 gap-4 items-center xl:justify-between">
              ...
              <div className=" space-y-4">
                ...
                <div className="">
                  ...
                  <p className=" pl-2">
                    ...
                    equipment and receive a<br className="hidden lg:block" /><span className="lg:pl-3"></span>{" "}
