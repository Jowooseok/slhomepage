...
function MainLayout({ children }) {
  return (
    <div
      id="root"
      className="flex flex-col min-h-screen mx-auto tracking-tight leading-5 text-[#171717] font-medium bg-slate-900 font-helvetica"
        ...
        <div className="w-full sm:w-5/12 sm:flex items-center justify-center py-4 sm:py-0 hidden">
          <a href="https://m.digiray.co.kr/" className=" bg-white rounded-md">
            <img
              ...
              alt="footerLogoImage"
              className=" md:max-w-[240px] lg:max-w-sm p-8"
            />
          </a>
        </div>
        <div className="w-full sm:w-0.5 h-auto bg-white my-4 sm:my-0 ">
          {""}
        </div>
        <div className="flex flex-col w-full sm:w-5/12 text-center sm:text-left text-white gap-6">
          <a
            href="https://m.digiray.co.kr/"
            className="w-full h-full flex items-center justify-center"
          >
            <img
              src={Images.DigirayLogo}
              alt="footerLogoImage"
              className="w-2/5  bg-white sm:hidden  p-4 rounded-md"
            />
          </a>
